...
ablation_code = """def run_ablation(data, retrieval_system):
...
security_code = """def security_baseline_eval(data, retrieval_system):
...
master_eval_code = """print("Running Master Comparative Evaluation...")
eval_results = []
...
# MASTER EXPORT
# Create a final csv that contains EACH AND EVERY number everything
# Combine everything into one big structure
# We have t1, t2, t4, err_df, ablation_df, sec_comp_df. We will save a master un-aggregated as well
